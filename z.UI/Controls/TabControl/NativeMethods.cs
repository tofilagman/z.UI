...
namespace z.UI.TabControl
{
    internal sealed class NativeMethods
    {
        ...
        public static IntPtr SendMessage(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            Control control__1 = Control.FromHandle(hWnd);
            if (control__1 == null)
            {
                return IntPtr.Zero;
            }
            ...
            MethodInfo wproc = control__1.GetType().GetMethod("WndProc", BindingFlags.NonPublic | BindingFlags.InvokeMethod | BindingFlags.FlattenHierarchy | BindingFlags.IgnoreCase | BindingFlags.Instance);
        ...
        {
            if ((dWord.ToInt32() & 0x80000000u) == 0x80000000u)
            {
