...
{
    [ToolboxBitmapAttribute(typeof(System.Windows.Forms.TabControl))]
    public class CustomTabControl : System.Windows.Forms.TabControl
    {
        ...
        public void ShowTab(string key)
        {
            if (this._TabPages != null)
            {
                TabPage tab = this._TabPages.Find((TabPage page) => page.Name.Equals(key, StringComparison.OrdinalIgnoreCase));
                this.ShowTab(tab);
            }
        }
        ...
        protected override void OnDragDrop(DragEventArgs drgevent)
        {
            ...
            if (drgevent.Data.GetDataPresent(typeof(TabPage)))
            {
                ...
                if (object.ReferenceEquals(this.ActiveTab, dragTab))
                {
                    return;
                }
        ...
        protected override void OnFontChanged(EventArgs e)
        {
            ...
            NativeMethods.SendMessage(this.Handle, NativeMethods.WM_SETFONT, hFont, new IntPtr(-1));
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            if (index > -1 && this.TabImageClick != null && (this.TabPages[index].ImageIndex > -1 || !string.IsNullOrEmpty(this.TabPages[index].ImageKey)) && this.GetTabImageRect(index).Contains(this.MousePosition))
            {
        ...
        private void CustomPaint(Graphics screenGraphics)
        {
            ...
            if (this.Width > 0 && this.Height > 0)
            {
                ...
                float m11, m22, m44;
                m11 = alphaMatrix.Matrix11;
                m22 = alphaMatrix.Matrix22;
                m44 = alphaMatrix.Matrix44;
                alphaMatrix.Matrix00 = InlineAssignHelper(ref m11, InlineAssignHelper(ref m22, InlineAssignHelper(ref m44, 1)));
                alphaMatrix.Matrix11 = m11;
                alphaMatrix.Matrix22 = m22;
                alphaMatrix.Matrix44 = m44;
        ...
        protected void PaintTransparentBackground(Graphics graphics, Rectangle clipRect)
        {
            ...
            if ((this.Parent != null))
            {
                ...
                graphics.TranslateTransform(Convert.ToSingle(-this.Location.X), Convert.ToSingle(-this.Location.Y));
        ...
        private Rectangle GetTabTextRect(int index)
        {
            ...
            using (GraphicsPath path = this._StyleProvider.GetTabBorder(index))
            {
                ...
                textRect = new Rectangle(Convert.ToInt32(Math.Truncate(tabBounds.X)), Convert.ToInt32(Math.Truncate(tabBounds.Y)), Convert.ToInt32(Math.Truncate(tabBounds.Width)), Convert.ToInt32(Math.Truncate(tabBounds.Height)));
                ...
                if (this.ImageList != null && (this.TabPages[index].ImageIndex > -1 || (!string.IsNullOrEmpty(this.TabPages[index].ImageKey) && !this.TabPages[index].ImageKey.Equals("(none)", StringComparison.OrdinalIgnoreCase))))
                {
                    ...
                    if ((this._StyleProvider.ImageAlign & NativeMethods.AnyLeftAlign) != (ContentAlignment)0)
                    {
                        if (this.Alignment <= TabAlignment.Bottom)
                        {
                            ...
                            textRect.Width -= (textRect.Right - Convert.ToInt32(Math.Truncate(tabBounds.Right)));
                        }
                        else
                        {
                            textRect.Y = imageRect.Y + 4;
                            textRect.Height -= (textRect.Bottom - Convert.ToInt32(Math.Truncate(tabBounds.Bottom)));
                        }
                        ...
                        if (this._StyleProvider.ShowTabCloser)
                        {
                            ...
                            if (this.Alignment <= TabAlignment.Bottom)
                            {
                                ...
                                {
                                    textRect.Width -= (Convert.ToInt32(Math.Truncate(tabBounds.Right)) - closerRect.X + 4);
                                }
                            }
                            else
                            {
                                ...
                                {
                                    textRect.Height -= (Convert.ToInt32(Math.Truncate(tabBounds.Bottom)) - closerRect.Y + 4);
                                }
                            }
                        }
                    }
                    ...
                    else
                    {
                        if (this.Alignment <= TabAlignment.Bottom)
                        {
                            textRect.Width -= (Convert.ToInt32(Math.Truncate(tabBounds.Right)) - imageRect.X + 4);
                        }
                        else
                        {
                            textRect.Height -= (Convert.ToInt32(Math.Truncate(tabBounds.Bottom)) - imageRect.Y + 4);
                        }
                        //	If there is a closer allow for it
                        if (this._StyleProvider.ShowTabCloser)
                        {
        ...
        public Point GetTabPosition(int index)
        {
            ...
            for (int testIndex = 0; testIndex <= this.TabCount - 1; testIndex++)
            {
        ...
        private Rectangle GetTabImageRect(GraphicsPath tabBorderPath)
        {
            ...
            if (this.Alignment <= TabAlignment.Bottom)
            {
                if ((this._StyleProvider.ImageAlign & NativeMethods.AnyLeftAlign) != (ContentAlignment)0)
                {
                    imageRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)), Convert.ToInt32(Math.Truncate(rect.Y)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Height)) - 16) / 2))), 16, 16);
                ...
                {
                    imageRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble((Convert.ToInt32(Math.Truncate(rect.Right)) - Convert.ToInt32(Math.Truncate(rect.X)) - Convert.ToInt32(Math.Truncate(rect.Height)) + 2) / 2)))), Convert.ToInt32(Math.Truncate(rect.Y)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Height)) - 16) / 2))), 16, 16);
                }
                else
                {
                    imageRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.Right)), Convert.ToInt32(Math.Truncate(rect.Y)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Height)) - 16) / 2))), 16, 16);
            ...
            else
            {
                if ((this._StyleProvider.ImageAlign & NativeMethods.AnyLeftAlign) != (ContentAlignment)0)
                {
                    imageRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Width)) - 16) / 2))), Convert.ToInt32(Math.Truncate(rect.Y)), 16, 16);
                    while (!tabBorderPath.IsVisible(imageRect.X, imageRect.Y))
                    {
                        imageRect.Y += 1;
                    }
                ...
                {
                    imageRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Width)) - 16) / 2))), Convert.ToInt32(Math.Truncate(rect.Y)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble((Convert.ToInt32(Math.Truncate(rect.Bottom)) - Convert.ToInt32(Math.Truncate(rect.Y)) - Convert.ToInt32(Math.Truncate(rect.Width)) + 2) / 2)))), 16, 16);
                }
                else
                {
                    imageRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Width)) - 16) / 2))), Convert.ToInt32(Math.Truncate(rect.Bottom)), 16, 16);
        ...
        public Rectangle GetTabCloserRect(int index)
        {
            ...
            using (GraphicsPath path = this._StyleProvider.GetTabBorder(index))
            {
                ...
                if (this.Alignment <= TabAlignment.Bottom)
                {
                    if (this.RightToLeftLayout)
                    {
                        closerRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.Left)), Convert.ToInt32(Math.Truncate(rect.Y)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Height)) - 6) / 2))), 6, 6);
                    ...
                    {
                        closerRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.Right)), Convert.ToInt32(Math.Truncate(rect.Y)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Height)) - 6) / 2))), 6, 6);
                ...
                else
                {
                    if (this.RightToLeftLayout)
                    {
                        closerRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Width)) - 6) / 2))), Convert.ToInt32(Math.Truncate(rect.Top)), 6, 6);
                    ...
                    {
                        closerRect = new Rectangle(Convert.ToInt32(Math.Truncate(rect.X)) + Convert.ToInt32(Math.Truncate(Math.Floor(Convert.ToDouble(Convert.ToInt32(Math.Truncate(rect.Width)) - 6) / 2))), Convert.ToInt32(Math.Truncate(rect.Bottom)), 6, 6);
